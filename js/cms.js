...
{
	newDiv = document.createElement("div");
	str = "<div style='margin-top:15px'>Video Title :</div>";
	str += "<div style='float:left; padding-bottom:5px;'><input type='text' name='vName[]' style='width:300px' /></div>";
	str += "<br style='clear: both;'>";
	
	str += "<div style=''>Link : </div>";
	str += "<div style='float:left; padding-bottom:5px;'><textarea name='videoUrl[]' rows='1' cols='110' style='width:430px'></textarea></div>";
	str += "<br style='clear: both;'>";
	
	str += "<div style=''>Video Description : </div>";
	str += "<div style='float:left; padding-bottom:5px;'><textarea name='contents[]' rows='2' cols='110' style='width:430px'></textarea></div>";
	str += "<hr style='clear: both;'>";
...
function changeTypeCat(box)
{
	location.href = "krishiobject.php?groupType=" + box.value;	
}

function changeTypeMagazine(box)
{
	location.href = "magazine.php?groupType=" + box.value;	
}
...
if (isset($_POST['save']))
{
 ...
 if (isset($_POST['id']))
 {
	...
	else if ($_POST['linkType'] == "Video Gallery")
  {
		...
		{
			if(!empty($_POST['vName'][$i]) and !empty($_POST['videoUrl'][$i]) and !empty($_POST['contents'][$i]))
			{
				$vid = $groups -> saveVideoSub("", $_POST['id'], $_POST['vName'][$i], $_POST['videoUrl'][$i], $_POST['contents'][$i]);
		...
		{
			if(!empty($_POST['oldvNames'][$i]) and !empty($_POST['oldUrls'][$i]) and !empty($_POST['oldContents'][$i]))
			 	$groups -> saveVideoSub($_POST['oldVideoIds'][$i], "", $_POST['oldvNames'][$i], $_POST['oldUrls'][$i], $_POST['oldContents'][$i]);
		}
  }	

...
elseif (isset($_GET['delete']))
{
	...
	$groups->delete($_GET['delete']);
	header("Location: subscribemail.php?msg=Category details deleted successfully");
	
}
elseif($_GET['type'] == "edit")
{
	echo "hi"; die();
	$row = $groups -> getById($id);
	extract($row);	
                  ...
                  <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="2"> 
                      ...
                      <tr>
						...
						<td><input type="tel" name="contents" value="<?php echo $contents; ?>" class="text" /></td>
                      </tr>
                          ...
                          <?php
							...
							{?>
                          		<tr <?php if($counter%2 != 0) echo 'bgcolor="#F7F7F7"'; else echo 'bgcolor="#FFFFFF"'; ?>>
                                    ...
                                    <td valign="top"> [ <a href="subscribemail.php?type=edit&id=<?= $row['id']?>">Edit</a> | <a href="#" onClick="javascript: if(confirm('This will permanently remove this Email info from database. Continue?')){ document.location='subscribemail.php?type=del&id=<?php echo $row['id']; ?>'; }">Delete</a> ]</td>
                          </tr>
